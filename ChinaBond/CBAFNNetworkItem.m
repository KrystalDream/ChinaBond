...
@implementation CBAFNNetworkItem
...
//        manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/x-json",@"text/json", nil];
        manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/x-json",@"application/json",nil];
//        manager.responseSerializer = [AFJSONResponseSerializer serializer];
        ...
        if (networkType==CBAFNNetWorkGET)
        {
