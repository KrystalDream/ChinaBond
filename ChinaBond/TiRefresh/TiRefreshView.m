...
-(void)setup{
    ...
    _refreshImageView.frame=CGRectMake((SCREEN_WIDTH-30)/2, 0, 30, self.bounds.size.height-25);
    [self addSubview:_refreshImageView];
    
//    [self setRefreshState:State_normal];
    
    self.gifImages=[NSMutableArray array];
    NSString *path=[[NSBundle mainBundle]pathForResource:@"refresh@2x" ofType:@"gif"];
